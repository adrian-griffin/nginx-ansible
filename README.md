...
[![CircleCI](https://circleci.com/gh/bassline/ansible-role-nginx.svg?style=svg)](https://circleci.com/gh/bassline/ansible-role-nginx)
...
Create the child template in the path you configured above and extend `bassline.nginx` template file relative to your `playbook.yml`.

```
{% extends 'roles/bassline.nginx/templates/nginx.conf.j2' %}
